...
function ENT:RefineryData()
	return true, {"industrial_metal_mixed", "industrial_carbon_mesh", "industrial_honey_comb"}, 1, {"industrial_adv_alloy", "industrial_carbon_plate", "industrial_honey"}, 10, 40, false
end
